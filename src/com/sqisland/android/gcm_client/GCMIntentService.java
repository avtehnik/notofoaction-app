...
public class GCMIntentService extends GCMBaseIntentService {
  ...
  protected void onMessage(Context context, Intent intent) {
     ...
     // System.out.println("[GCMIntentService] Message Received! " + intent.getStringExtra("message"));
	  ...
	  String data = intent.getStringExtra("windowstate");
	  
    NotificationManager manager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
    Notification notification = prepareNotification(context, msg, data);
    
    manager.notify(R.id.notification_id, notification);
  }

  private Notification prepareNotification(Context context, String msg, String data) {
    ...
    intent.putExtra(Constants.FIELD_DATA, data);
